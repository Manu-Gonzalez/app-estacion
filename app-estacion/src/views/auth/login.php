    ...
    <div class="w-full max-w-md">
        <div class="bg-white bg-opacity-95 p-8 rounded-2xl shadow-xl">
            <div class="text-center mb-8">
                ...
                <h1 class="text-indigo-600 text-3xl font-bold">Iniciar Sesión</h1>
            </div>
            ...
            <div class="text-center mt-6 space-y-3">
                <a href="recovery" class="block text-indigo-600 hover:text-indigo-800 transition-colors flex items-center justify-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    ¿Olvidaste tu contraseña?
                </a>
                <a href="register" class="block text-indigo-600 hover:text-indigo-800 transition-colors flex items-center justify-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
